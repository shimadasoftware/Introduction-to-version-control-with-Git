...
````
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/57f59039-dadd-401a-949c-8ed1afb2c3f4)
...
vim id_rsa.pub
````
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/44d20ca0-a2a8-4aff-9256-542d60e23f61)

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/67a208ec-9ca3-415a-8a34-a681fd160514)

Para salir de Vim digite :q

````
ssh-rsa  juana@fedora
````
...
cat ~/.ssh/id_rsa.pub
````
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/e9e72292-5925-4900-abab-913b27fca389)

3. Ve a la página de configuración de tu cuenta de GitHub.

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/88f70f06-67a0-4827-8ee9-8c9117c2c40b)

4. Haz clic en la pestaña "SSH y claves de acceso". Haz clic en el botón "Agregar clave".

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/ad0c4ca2-af76-4ee5-9a6e-cd1a06c907cd)

5. Pega la clave pública que copiaste en el paso 2 y haz clic en el botón "Agregar clave".

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/9b97e675-8bc4-4953-9353-0f01629bbc35)

6. A continuación, se muestra que se ha agragado la llave SSH.

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/47fd258d-1939-4529-8ae2-04678e773863)
...
````
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/0ea46b17-b139-430c-95c9-53ec589e08be)
...
git clone git@github.com:[shimadasoftware]/[Samsung-Innovation-Campus-Course].git
````
...
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/97d0388a-9138-4b27-9f0b-1c7d83d2d131)
