...
sudo dnf update -y
````
![image](https://github.com/shimadasoftware/learning-git-and-github/blob/main/img/modulo%201%20img%201.png)
...
````
![image](https://github.com/shimadasoftware/learning-git-and-github/blob/main/img/modulo%201%20img%202.png)
...
git --version
````
![image](https://github.com/shimadasoftware/learning-git-and-github/blob/main/img/modulo%201%20img%203.png)
...
````
![git user](https://github.com/shimadasoftware/learning-git-and-github/blob/main/img/modulo%201%20img%204.png)
...
cd Cats
````
![image](https://github.com/shimadasoftware/learning-git-and-github/blob/main/img/modulo%201%20img%205.png)
...
git checkout -b main
````
![image](https://github.com/shimadasoftware/learning-git-and-github/blob/main/img/modulo%201%20img%206.png)
...
````
![image](https://github.com/shimadasoftware/learning-git-and-github/blob/main/img/modulo%201%20img%207.png)
...
ls -a
````
![image](https://github.com/shimadasoftware/learning-git-and-github/blob/main/img/modulo%201%20img%208.png)
...
git --help
````
![image](https://github.com/shimadasoftware/learning-git-and-github/blob/main/img/modulo%201%20img%209.png)
