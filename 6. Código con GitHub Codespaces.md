...
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/e6483ed6-e3f5-49e1-9e55-dd58c25e4679)
...
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/121591be-ce39-4857-9148-1cb8338e543e)

3. Después de crear su nuevo repositorio, espere unos 20 segundos y luego actualice la página. Siga las instrucciones paso a paso en el archivo README del nuevo repositorio.

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/7c26f7db-431d-4a93-a8e2-52e6b3c46800)
...
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/1adca6e6-39c0-4b39-a2de-8c7253883b20)

2. Haga clic en el botón verde **Code** ubicado en el medio de la página.

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/46d49b96-f31a-4a28-bafe-b3565d9d5692)
...
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/36d2d416-ebf3-4034-bacd-46daa4f75c5b)
...
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/3e5d8c2d-5f74-4a00-9876-6ffe1de9e345)
...
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/3815fee7-19a0-4030-917c-703529e8085e)
...
2. Reemplace el encabezado **h1** con lo siguiente:
   ...
   ```
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/3827c28e-ba63-49a7-88ca-5251b481dd53)
...
3. Utilice la terminal VS Code para confirmar el cambio de archivo ingresando el siguiente mensaje de confirmación:
   ...
   ```
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/4c2e0cc4-1425-43e7-a408-b3d7defa9f1a)
...
4. Envíe (push) los cambios a su repositorio. Desde la terminal VS Code, ingrese:
   ...
   git push
   ```
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/9c44b647-2482-413e-a3ab-13c17a3d5c3f)
...
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/4bee8f31-d089-45a6-83f4-d0c28b9a438d)
...
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/c370ec7a-8f88-41ea-94e8-20c7e3be2910)
...
2. Escriba o pegue lo siguiente en el campo de texto vacío para nombrar su archivo.
   ...
   ```
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/c8d1666d-375b-4200-8f87-7471db95c307)
...
3. En el cuerpo del nuevo archivo **.devcontainer/devcontainer.json**, agregue el siguiente contenido:
   ...
   ```
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/4e8bafc7-5abc-4212-a056-663a71eda800)

4. Haga clic en **Commit changes** y luego seleccione **Commit changes directly to the `main` branch**.

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/c3d9afb3-548b-4f89-b6e4-458dd7d3397f)

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/89a4b175-5702-4990-813c-bfab4187b3f0)

5. Crea un nuevo espacio de código volviendo a la pestaña **Code** de tu repositorio.

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/bace847c-b166-4037-b0a5-706f11d1791c)

6. Haga clic en el botón verde **Code** ubicado en el medio de la página.

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/c5c51c41-42b5-40c7-a458-27f16ebe583f)

7. Haga clic en la pestaña **Codespaces** en el cuadro que aparece.

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/df96fd6e-123b-456e-80ed-ccbeaf9f5e66)
...
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/f5bc5185-6ff1-4742-a097-9aa8b2e73098)
...
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/d6fb7a3a-2207-4259-a8f2-e72caa4eefbb)
...
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/13e628e7-1cca-4b01-84d2-384dca64f29c)
...
2. Agregue las siguientes personalizaciones al cuerpo del archivo antes del último `}`.
   ...
   ```
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/3af9e93c-1565-4ccf-ba52-3d8ca759290a)

3. Haga clic en **Commit changes** y luego seleccione **Commit changes directly to the `main` branch**.

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/382ae0dd-9766-4816-ba6d-f2ace735e49a)

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/4b0b1e09-8f32-42b6-bbf9-2a8c11feeefa)

4. Cree un nuevo codespace navegando a la página de inicio de su repositorio.

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/47521de2-6c6a-48cb-8d3e-252a65842776)

5. Haga clic en el botón **Code** ubicado en el medio de la página.

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/055528e7-fae1-4706-80f2-0ce1ab50dde9)

6. Haga clic en la pestaña **Codespaces** en el cuadro que aparece.

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/0cd2a8e4-389e-45e4-bd0a-ea9106302485)

7. Click the **Create codespace on main** button.

   > Wait about **2 minutes** for the codespace to spin itself up.

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/0e9b8df8-a23d-441d-9461-6e2aada5359b)
...
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/60836344-d9ff-46ab-8c49-1141589f8ab3)
...
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/e6bcfe37-c11e-4412-85f2-de8015ae0e1b)
...
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/66227610-0d02-4f1b-b976-d1890adf58f4)
...
2. Add the following postCreateCommand to the body of the file before the last `}`.
   ...
   ```
![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/2fa6f5d7-de93-4f6e-b4e5-08ca1af5fc06)

3. Click **Commit changes** and then select **Commit changes directly to the `main` branch**.

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/c3802e87-8476-454b-9bda-df6c0f54e08f)

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/0cbd4062-a1a9-4b63-854a-710afb871778)

4. Create a new codespace by navigating to the landing page of your repository.

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/1ad90bdf-f56c-4d94-85d9-76c8aece85e4)

5. Click the **Code** button located in the middle of the page.

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/bb3a771c-12bf-4323-9108-28af30fa08fd)

6. Click the **Codespaces** tab on the box that pops up.

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/b4ac009a-26f2-42e7-ba69-0b5c548c1464)

7. Click the **Create codespace on main** button.

   > Wait about **2 minutes** for the codespace to spin itself up.

![image](https://github.com/shimadasoftware/Learning-Git-and-GitHub/assets/73977456/4fbf5c82-86a6-4aeb-8216-1f39dcc0ed44)
