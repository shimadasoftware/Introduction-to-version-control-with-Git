...
2. Agregue el siguiente comando postCreateCommand en el cuerpo del archivi antes del último `}`.
...
5. Clic el botón **Code** localizado en la mitad de la pagina.
...
7. Clic en el botón **Create codespace on main**.
...
#### Paso 4: Personalize su codespace!
...
![image](./img/modulo%206%20img%2051.png)
...
![image](./img/modulo%206%20img%2052.png)

### :keyboard: Actividad: agregue un `dotfile` a su repositorio y ejecute su espacio de código

1. Comience desde la página de inicio de su repositorio.

![image](./img/modulo%206%20img%2053.png)

2. Haga clic en el botón **Code** >> **Codespaces** >> **Create codespace on main**.

![image](./img/modulo%206%20img%2054.png)

Sin embargo, se produce el siguiente error que indica que para mi caso, el número máximo de codeplaces ha sido superado. Por lo tanto, se decidió borrar un codeplace viejo y ejecutar uno nuevo.

![image](./img/modulo%206%20img%2045.png)
...
![image](./img/modulo%206%20img%2057.png)
...
3. Agregue el siguiente código dentro del archivo:
   ...
   ```
![image](./img/modulo%206%20img%2055.png)
![image](./img/modulo%206%20img%2056.png)

4. Guarde el archivo.
   > **Note**: The file should autosave.

5. Haga un commit y un push para los cambios en el archivo. Desde la terminal de VS Code terminal ingrese:
   ...
   git push
   ```
![image](./img/modulo%206%20img%2058.png)

6. Vuelva a la página de inicio de su repositorio y vea `setup.sh` para verificar que el nuevo código se haya enviado a su repositorio.

![image](./img/modulo%206%20img%2059.png)

7. Cierra la pestaña del navegador web de Codespace.

10. Clic en el botón **Create codespace on main**. Este paso se omite debído a que se superó la capacidad de los codespaces.

![image](./img/modulo%206%20img%2062.png)
...
13. Desde la terminal VS Code, escriba o pegue:
   ...
   /usr/games/sl
   ```
![image](./img/modulo%206%20img%2060.png)

13. Disfrute el show!

![image](./img/modulo%206%20img%2061.png)
